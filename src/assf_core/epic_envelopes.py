...
class GithubIssueSchema(BaseModel):
    ...
    description: str = Field(
        ...,
        description="The Markdown body of the issue, strictly following the ASSF Feature Template.",
    )
    labels: list[str] = Field(default=["assf:backlog"], description="Labels to attach.")
