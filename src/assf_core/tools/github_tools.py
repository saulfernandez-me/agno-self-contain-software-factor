...
class GitHubTools(Toolkit):
    """
    Agno Toolkit for ASSF Github SDLC integration.
    ...
    def add_label(self, issue_number: int, label: str) -> str:
        """
        Adds a label to a GitHub issue. Useful for ASSF state transitions (e.g. assf:planning).

        Args:
            issue_number: The number of the GitHub issue.
            label: The label to add (e.g., "assf:planning").
