...
def get_models_for_tier(tier_name: str, config: ApfConfig | None = None) -> list[str]:
    ...
    if tier_name == "heavy":
        return ["google:gemini-3.1-pro-preview", "deepseek:deepseek-reasoner", "anthropic:claude-fable-5"]
        ...
        return ["google:gemini-2.5-flash", "deepseek:deepseek-chat", "anthropic:claude-haiku-4-5-20251001"]
