...
class GitHubTools(Toolkit):
    """
    Agno Toolkit for ASF Github SDLC integration.
    ...
    def add_label(self, issue_number: int, label: str) -> str:
        """
        Adds a label to a GitHub issue. Useful for ASF state transitions (e.g. asf:planning).

        Args:
            issue_number: The number of the GitHub issue.
            label: The label to add (e.g., "asf:planning").
