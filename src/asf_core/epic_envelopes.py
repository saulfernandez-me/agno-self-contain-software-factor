...
class GithubIssueSchema(BaseModel):
    ...
    description: str = Field(
        ...,
        description="The Markdown body of the issue, strictly following the ASF Feature Template.",
    )
    labels: list[str] = Field(default=["asf:backlog"], description="Labels to attach.")
