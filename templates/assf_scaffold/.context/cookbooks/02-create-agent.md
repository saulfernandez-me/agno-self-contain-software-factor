# Cookbook 02: Creating an Agno Agent for ASSF

> **Purpose:** This guide dictates how to instantiate and configure an Agno `Agent` so it complies with the strict physical contract boundaries (Pydantic Envelopes) of ASSF.
...
from assf_core.envelopes import EnvelopeBase
