...
## 1. The Pydantic Engine in ASSF
ASSF uses Pydantic V2 to enforce data contracts between nodes. When you (the Agent) are instantiated, your Agno wrapper is configured with a `response_model` (e.g., `BuildEnvelope`).
