...
Autonomous agents (ASSF, Cursor, Claude Code) read this file before modifying ANY code.
...
## 5. Active Workflows (ASSF)
This repository uses the Agno Self-Contain Software Factor (ASSF).
