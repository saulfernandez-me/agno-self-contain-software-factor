...
def get_product_strategist_agent(
    domain_context: str,
    ...
    """
    Factory for the Product Strategist Agent.
    """
    behavior_file = Path(".context/agents/product_strategist_behavior.md")
    behavioral_harness = (
        behavior_file.read_text(encoding="utf-8")
        if behavior_file.exists()
        else "You are a Product Strategist. Synthesize research into clear Epic opportunities."
    )
