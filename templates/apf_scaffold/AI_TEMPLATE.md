...
Autonomous agents (APF, Cursor, Claude Code) read this file before modifying ANY code.
...
- **Domain:** [e.g., Product Engineering / Agroforestry / RPG Content]
...
## 5. Active Workflows (APF)
This repository uses the Agno Self-Contain Software Factor (APF).
To execute a task, use one of the pre-configured workflow runners located in `workflows/`:
- `standard_pdlc`: Use for complex feature implementation.
