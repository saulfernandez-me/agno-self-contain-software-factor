...
This document defines the quality rules and global acceptance criteria that every Issue, Pull Request, and line of code in **APF** must meet before being considered "Done".
...
- **Source Directory:** `src/apf_core/` (Installable library).
